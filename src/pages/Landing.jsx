        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-container-margin-desktop py-16">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8">
            ...
            <div className="md:col-span-2 space-y-4">
              ...
              <ul className="space-y-3">
                <li><button className="text-slate-400 hover:text-secondary text-sm transition-colors bg-transparent border-none cursor-pointer text-left">Support</button></li>
                <li><button className="text-slate-400 hover:text-secondary text-sm transition-colors bg-transparent border-none cursor-pointer text-left">Feedback</button></li>
