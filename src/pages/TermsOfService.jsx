      ...
      <main className="pt-32 pb-20 px-6 max-w-[800px] mx-auto">
        <section className="mb-10 text-center">
          <div className="w-16 h-16 rounded-full bg-[#41eec2]/10 border border-[#41eec2]/35 flex items-center justify-center mb-6 mx-auto">
            <FileText className="text-[#41eec2] w-8 h-8" />
          </div>
        ...
        <section className="glass-panel p-8 rounded-2xl border border-white/5 space-y-6 text-[#c4c6cc] text-sm leading-relaxed mb-16">
          <div>
            <h2 className="text-lg font-bold text-white mb-2" style={{ fontFamily: 'Sora, sans-serif' }}>1. Terms Acceptance</h2>
            <p>
              By accessing or logging into CleanSweep, you agree to comply with and be bound by these Terms of Service. If you do not agree, please do not use the application.
            </p>
          </div>

          <div>
            <h2 className="text-lg font-bold text-white mb-2" style={{ fontFamily: 'Sora, sans-serif' }}>2. Report Accuracy & Fraud Prevention</h2>
            <p>
              Users must submit genuine reports containing accurate coordinates and truthful media showing trash. Submitting fake cleanup logs, stock/unrelated images, or duplicating reports is strictly prohibited and will result in point forfeitures and profile suspension.
            </p>
          </div>

          <div>
            <h2 className="text-lg font-bold text-white mb-2" style={{ fontFamily: 'Sora, sans-serif' }}>3. Reward System</h2>
            <p>
              CleanPoints are earned dynamically through active, verified contributions. Points carry no cash value and can only be redeemed within the Marketplace for ecological grants (like sapling tree planting sponsorships).
            </p>
          </div>

          <div>
            <h2 className="text-lg font-bold text-white mb-2" style={{ fontFamily: 'Sora, sans-serif' }}>4. Route Usage Limitation</h2>
            <p>
              The optimized route calculations provided on the Admin dashboard are meant exclusively for municipal or coordinated community team cleanup squads. We are not liable for route diversions or road safety conditions.
            </p>
          </div>
        </section>
      </main>
