      ...
      <main className="pt-32 pb-20 px-6 max-w-[800px] mx-auto">
        <section className="mb-10 text-center">
          <div className="w-16 h-16 rounded-full bg-[#41eec2]/10 border border-[#41eec2]/35 flex items-center justify-center mb-6 mx-auto">
            <Shield className="text-[#41eec2] w-8 h-8" />
          </div>
        ...
        <section className="glass-panel p-8 rounded-2xl border border-white/5 space-y-6 text-[#c4c6cc] text-sm leading-relaxed mb-16">
          <div>
            <h2 className="text-lg font-bold text-white mb-2" style={{ fontFamily: 'Sora, sans-serif' }}>1. Introduction</h2>
            <p>
              CleanSweep ("we", "us", "our") is dedicated to protecting the privacy of our users. This Privacy Policy details how we collect, process, and safeguard information submitted on our website and application.
            </p>
          </div>

          <div>
            <h2 className="text-lg font-bold text-white mb-2" style={{ fontFamily: 'Sora, sans-serif' }}>2. Data We Collect</h2>
            <ul className="list-disc list-inside space-y-2 pl-2">
              <li><strong className="text-white">Account Details:</strong> Email addresses and profiles when users sign up via Supabase Auth.</li>
              <li><strong className="text-white">Geo-location Data:</strong> Accurate GPS coordinates are processed when users upload cleanup reports to position garbage dumps correctly on our Map.</li>
              <li><strong className="text-white">Report Media:</strong> Photographs of dumpsites uploaded for classification by our AI algorithms.</li>
            </ul>
          </div>

          <div>
            <h2 className="text-lg font-bold text-white mb-2" style={{ fontFamily: 'Sora, sans-serif' }}>3. How We Use Information</h2>
            <p>
              The collected information is used to verify cleanup reports, calculate fuel-efficient routes for waste collectors, update city-wide heatmaps, and credit earned rewards (CleanPoints) to profiles. We do not sell or monetize personal data.
            </p>
          </div>

          <div>
            <h2 className="text-lg font-bold text-white mb-2" style={{ fontFamily: 'Sora, sans-serif' }}>4. Data Protection & Security</h2>
            <p>
              We implement comprehensive technical and organizational safeguards through our secure server frameworks to prevent unauthorized access or disclosure of sensitive user reports.
            </p>
          </div>
        </section>
      </main>
